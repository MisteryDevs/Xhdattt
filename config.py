...
BOT_OWNER = os.getenv("BOT_OWNER", "@Rishu1286")  # Owner username

# -------------------------
# Support & Channel
# -------------------------
SUPPORT_CHAT_ID = os.getenv("SUPPORT_CHAT_ID", "ur_support07")  # Support chat
CHANNEL_ID = os.getenv("CHANNEL_ID", "Nenobots")                 # Channel for updates
